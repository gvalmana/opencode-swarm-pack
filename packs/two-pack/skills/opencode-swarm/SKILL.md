---
name: opencode-swarm
description: Use when running OpenCode multi-agent swarm workflows such as swarm-two, two-pack, adversaries, four-pack, six-pack, or squad-style role orchestration with small commits.
---
...
Subagents do not talk directly to the user unless they are the orchestrator or squad leader.
